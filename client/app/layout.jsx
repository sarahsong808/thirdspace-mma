...
export const metadata = {
  ...
  keywords: [
    ...
    'Muay Thai Van Nuys',
    'Jiu Jitsu Van Nuys',
    'martial arts Van Nuys',
    'MMA North Hollywood',
    'Muay Thai North Hollywood',
    'BJJ North Hollywood',
    'martial arts North Hollywood',
    'MMA Pacoima',
    'Muay Thai Pacoima',
    'MMA Panorama City',
    'MMA Arleta',
...
export default function RootLayout({ children }) {
  const localBusinessSchema = {
    ...
    areaServed: [
      ...
      { '@type': 'Neighborhood', name: 'Van Nuys', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'North Hollywood', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Pacoima', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Panorama City', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Arleta', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Sun Valley', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Sunland', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Tujunga', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Porter Ranch', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'West Hills', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Canoga Park', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Woodland Hills', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Tarzana', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Encino', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Sherman Oaks', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Studio City', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Reseda', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Winnetka', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
      { '@type': 'Neighborhood', name: 'Lake Balboa', containedInPlace: { '@type': 'City', name: 'Los Angeles' } },
